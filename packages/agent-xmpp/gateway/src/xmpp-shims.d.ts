declare module '@xmpp/xml' {
  ...
  export class Parser {
    on(event: 'start' | 'element' | 'end', handler: (element: Element) => void): this;
...
declare module '@xmpp/component' {
  ...
  export function component(options: { service: string; domain: string; password: string }): ComponentClient;
}
