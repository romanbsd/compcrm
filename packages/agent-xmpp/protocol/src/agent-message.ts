...
export type MessageKind = 'text' | 'task' | 'result' | 'error' | 'file' | 'command' | 'event';
...
export type InboundEnvelope = InboundMessage | InboundEvent | InboundCommand | InboundLifecycleEvent;
