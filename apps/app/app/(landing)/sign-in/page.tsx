...
async function SignIn({
	...
	const parsedParams = signInSearchParams.safeParse(params);
	if (!parsedParams.success) {
		return <InvalidOAuthRequest />;
	}
	const parsedSearchParams = parsedParams.data;
	const oauthQuery = parsedSearchParams.sig
		? serializeOAuthQuery(parsedSearchParams)
		: null;
	const method = parsedSearchParams.method;
